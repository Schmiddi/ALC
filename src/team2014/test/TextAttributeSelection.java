...
public class TextAttributeSelection {
	...
	public static void main(String[] args) {
		...
		TextAttributeSelection testRun = new TextAttributeSelection();
		...
		try {
			...
			//save to CSV
			WekaMagic.printHashMap(results.get(0), arff_dir + "text_result_train_cross_validation.csv");//Train set
			WekaMagic.printHashMap(results.get(1), arff_dir + "text_result_cross_cross_validation.csv");//Cross set
			
					
			//Plot everything
			System.out.println("Plotting results...");
			
			System.out.println("Creating chart " + arff_dir + "text_plot_train_cross_validation.png ...");
			GeneratesPlot.createSound(results.get(0), arff_dir, "text_plot_train_cross_validation.png");
			
			System.out.println("Creating chart " + arff_dir + "text_plot_test_cross_validation.png ...");
			GeneratesPlot.createSound(results.get(1), arff_dir, "text_plot_test_cross_validation.png");
