...
public class GeneratesPlot {
	 ...
	 * 
	 * @param myList
	 *            List containing the values to process
	 * @param outputFolder
	 *            Fold where to store the generated file
	 * @param filename
	 *            Name of the png file generated by the method
	 * @param xLabel
	...
	public static void create(List<List<Double>> myList, String outputFolder, String filename,
		...
		final JFreeChart chart = createChart(dataset, filename, xLabel, yLabel);
	 ...
	 * @return a chart.
	 */
	private static JFreeChart createChart(final XYDataset dataset, String title, String xLabel,
			String yLabel) {
	...
	private static void createPNG(JFreeChart chart, String outputFolder, String filename) {
		...
		try {
			...
			File outputfile = new File(outputFolder + filename + ".png"); // File
																			// Name
	...
	public static void printLearningCurve(List<List<Double>> myList, String outputFolder,
			String filename) {
	...
	private static JFreeChart createChartLC(final XYDataset dataset, String title) {
		...
		final JFreeChart chart = ChartFactory.createXYLineChart(title, // chart
				...
				"FScore", // y axis label
				dataset, // data
				PlotOrientation.VERTICAL, true, // no legend
				true, // tooltips
				false // urls
				);
	...
	public static void main(final String[] args) {
		...
		GeneratesPlot.create(myList, "", "Test", "Threshold", "UAR");
	}
